...
------
RegisterNetEvent('phant_sounds:client:PlayOnOne')
AddEventHandler('phant_sounds:client:PlayOnOne', function(soundFile, soundVolume)
    SendNUIMessage({
...
------
RegisterNetEvent('phant_sounds:client:PlayOnAll')
AddEventHandler('phant_sounds:client:PlayOnAll', function(soundFile, soundVolume)
    SendNUIMessage({
        transactionType     = 'playSound',
        transactionFile     = soundFile,
        transactionVolume   = soundVolume
...
------
RegisterNetEvent('phant_sounds:client:PlayWithinDistance')
AddEventHandler('phant_sounds:client:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
...
RegisterNetEvent('phant_sounds:client:PlayWithinDistanceOS')
AddEventHandler('phant_sounds:client:PlayWithinDistanceOS', function(playerCoords, maxDistance, soundFile, soundVolume)
    local lCoords = GetEntityCoords(Citizen.InvokeNative(0x43A66C31C68491C0,-1))
